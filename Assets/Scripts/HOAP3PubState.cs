...
public class HOAP3PubState : MonoBehaviour
{
    // ROS Connector
    ...
    {
        HOAP3Joints joints = new HOAP3Joints();
        ...
        joints.joint_29 = jointArticulationBodies[29].xDrive.target;
        joints.joint_30 = jointArticulationBodies[30].xDrive.target;
        joints.joint_31 = jointArticulationBodies[31].xDrive.target;
        joints.joint_32 = jointArticulationBodies[32].xDrive.target;
        joints.joint_33 = jointArticulationBodies[33].xDrive.target;
