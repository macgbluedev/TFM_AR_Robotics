...
namespace RosMessageTypes.Ur3Moveit
{
    public class UR3MoverServiceResponse : Message
    {
        ...
        {
            return "UR3MoverServiceResponse: " +
